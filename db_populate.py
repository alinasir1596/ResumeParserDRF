...
k_tag = ["tool", "language", "skill", "framework"]
tool = KeywordTag(name='tool')
language = KeywordTag(name='language')
skill = KeywordTag(name='skill')
framework = KeywordTag(name='framework')
...
for sk, sk_tag in skills_set:
    ...
    try:
        if sk_tag == 'tool':
            k_word = Keyword(keyword_value=sk, keyword_tag=tool)
            k_word.save()
        elif sk_tag == 'language':
            k_word = Keyword(keyword_value=sk, keyword_tag=language)
            k_word.save()
        elif sk_tag == 'skill':
            k_word = Keyword(keyword_value=sk, keyword_tag=skill)
            k_word.save()
        elif sk_tag == 'framework':
            k_word = Keyword(keyword_value=sk, keyword_tag=framework)
            k_word.save()
    except Exception as e:
        pass
