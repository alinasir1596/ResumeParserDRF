...
from api.models import KeywordTag, Keyword
...
class KeywordManagementTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.data = {"keyword_value": "test value",
                     "keyword_tag": keyword_tag.id}
        # self.data.save()
...
class GetTaskTestCase(APITestCase):
    def setUp(self):
        ...
        self.data = {"keyword_value": "test value",
                     "keyword_tag": self.keyword_tag.id}
...
class UpdateTaskTestCase(APITestCase):
    def setUp(self):
        ...
        self.keyword.save()
        self.data = {"keyword_value": "test value",
                     "keyword_tag": self.keyword_tag.pk}
...
class DeleteTaskTestCase(APITestCase):
    def setUp(self):
        ...
        self.headers = {
            ...
            'Authorization': f'6251655368566D597133743677397A24'
        }
        self.keyword_tag = KeywordTag(name="test s dDf")
        self.keyword_tag.save()
        self.keyword = Keyword(keyword_value="test value", keyword_tag=self.keyword_tag)
            ...
            "experience": [
                {
                    ...
                    "description": "Baltimore, MD \n Project : Zbizlink \n Project Description : ZBizlink https : www.zbizlink.com \n This "
                                   "SaaS-based solution contains approximately 16 sub-projects and two web "
                                   "interfacing portals for end "
                                   "users. It is a fully integrated solution using a Microsoft SharePoint Portal online for its document "
                                   "repository and Microsoft Dynamics CRM 2016 for candidates tracking. It has a "
                                   "normalized transactional "
                                   "database and a separate data warehouse for reporting, analysis, and statistics. This solution contains "
                                   "high level features such as : \n Vendors Management-Manage vendors' data and vendors' performance \n "
                                   "Procurement Management-Locates and displays new proposal's RFP/RFR/RFQ etc. and evaluates/scores "
                                   "vendors' proposal'submissions. \n Capture Management-Builds proposal response templates and plugs in "
                                   "appropriate content, identifies proposal team members, and enables collaboration among teams in order "
                                   "to submit successful proposal responses. \n Dashboard and Reports-Provides various widgets that "
                                   "provide information and drive dynamic collaboration, such as customized matrix reports. \n Completed "
                                   "this project within a very tight timeline and budget. Coordinated with team of 12 resources on a daily "
                                   "basis to ensure that all work performed met expected results. It is quite an accomplishment for a team "
                                   "this size, in this timeframe and with this budget to deliver a working software product of this size "
                                   "and complexity. The application is getting very high marks from business users. \n Other projects "
                                   "include data warehouses, portals, architecture and development, conversion, configuration management, "
                                   "change management, release management, and testing efforts. \n General Responsibilities for all ZDAAS "
                                   "Projects \n Design and direct development of IT strategy that supports company's "
                                   "strategic mission and "
                                   "business plan. Implement and manage strategy across IT domain. \n Develop and ensure compliance to "
                                   "corporate IT standards and policies to ensure compatibility and integration throughout company. \n "
                                   "Configure, Install and manage Cloud environments 12 VM Servers and three separate regions on Windows "
                                   "Azure for Zbizlink Production and Test environments. Prepare always On and Azure Cloud as well as "
                                   "prepared backup policies for VM backup, application backup, databases backups and environments "
                                   "configurations backup. \n Developed Agile SCRUM artifacts including guidelines, standards, "
                                   "and best practices to manage the development of ZBizlink. Oversees adherence to, and use of "
                                   "development methodologies, frameworks, and project tools. Supports and advises team on all technical "
                                   "and performance-impacting issues. \n Strategically plan and manage initiatives consisting of program "
                                   "components that meet stakeholder expectations. \n Report to Sr. Executive Management; authorize and "
                                   "manage internal and external relationships and dependencies across initiative components to ensure "
                                   "successful delivery of the program. \n Ensure efficient distribution of the technical and business "
                                   "resources; and will coordinate with business executives the initiation or continuation of project "
                                   "based on business requirements, business performance and available organizational resources. \n "
                                   "Responsible for establishing and executing adequate project management controls based on industry "
                                   "accepted methodologies and standards. \n Committed to monitor and control cost, schedule, performance "
                                   "and risk; to ensure quality and security; overall integration and issues resolution and to perform "
                                   "administrative functions. \n Co-ordinate with executive management, prepare annual budget and spending "
                                   "strategies, and monitor business and financial performance of initiative components from strategic "
                                   "perspective. \n Attend and/or leads technical discussions/JAD sessions with application designers, "
                                   "developer's, architects, business analysts, senior-level business executives, and content strategists "
                                   "to develop complex designs, business solutions, and management plans mapped to business demands. \n "
                                   "Manage multiple projects and all project requirements-conduct functional and non-functional "
                                   "requirements analysis; provides complex project and system analysis. \n Manage day to day business "
                                   "tasks and client-driven assignments and deliverables using PMI, PMBOK, and Agile development models "
                                   "including SCRUM . \n Attend meetings; create and deliver status and project reports to client's and "
                                   "their senior technical staff members; facilitates communication between all key IT groups, business, "
                                   "and the customer community. \n Recruit and interview resources; direct, train, and mentor all "
                                   "individuals and teams. Provides governance and oversight. Manage multiple teams simultaneously. Verify "
                                   "and validate work quality, timeliness and Agile compliance by resources. \n Responsible for all design "
                                   "and development, including : \n Architecture - Co-ordinate Microsoft Dynamics CRM architectural, "
                                   "integration parameters with internal and external components including interfaces for Zbizlink with "
                                   "SharePoint and CRM Dynamics. \n Enhancements, new features and upgrades development, testing, "
                                   ...
                                   "Microsoft Team Foundation Server, Microsoft Dynamics CRM 2016 SharePoint 2016 Live, Vision, "
                                   "Microsoft Framework 6.0, C#, Java, AngularJS, MVC 5.0, Entity Framework 5.0, ASP.NET, SQL Server "
                                   "2014.{#}",
                    "clientName": "",
                    "projectName": "",
                    "tools": "",
